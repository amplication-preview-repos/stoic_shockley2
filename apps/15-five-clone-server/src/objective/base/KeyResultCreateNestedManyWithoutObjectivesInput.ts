...
@InputType()
class KeyResultCreateNestedManyWithoutObjectivesInput {
...
export { KeyResultCreateNestedManyWithoutObjectivesInput as KeyResultCreateNestedManyWithoutObjectivesInput };
