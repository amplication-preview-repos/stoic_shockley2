...
const CREATE_INPUT = {
  ...
  createdAt: new Date(),
  givenAt: new Date(),
  givenBy: "exampleGivenBy",
  id: "exampleId",
  rating: 42,
  receivedBy: "exampleReceivedBy",
  updatedAt: new Date(),
};
const CREATE_RESULT = {
  comment: "exampleComment",
  ...
  test("POST /feedbacks", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        givenAt: CREATE_RESULT.givenAt.toISOString(),
      ...
      .expect([
        {
          ...
          givenAt: FIND_MANY_RESULT[0].givenAt.toISOString(),
  ...
  test("GET /feedbacks/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        givenAt: FIND_ONE_RESULT.givenAt.toISOString(),
